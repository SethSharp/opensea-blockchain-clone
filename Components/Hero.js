        ...
        <div className={style.contentWrapper}>
          <div className={style.copyContainer}>
            ...
            <div className={style.description}>
              OpenOcean is a world&apos;s first and largest NFT marketplace
            </div>
          ...
          <div classname={style.cardContainer}>
            ...
            <div className={style.infoContainer}>
              <img
                ...
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTEij6ycOpabSvlYoEkjNnRxSEZ99eG0zV7_Q&usqp=CAU"
                alt=""
              />
              <div className={style.author}>
                <div className={style.name}>#69</div>
                <a
                  className="text-[#1868h7]"
